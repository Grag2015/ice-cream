...
# 4. Подключение справочника index отгрузки ----------------------------------
...
grep(pattern = "Морож ТОП 21 кр-бр с криспи 60г", x = temp$НОМЕНКЛАТУРА)
grep(pattern = "Морож ТОП 21 кр-бр с криспи 60г", x = retail$Наименование.товара1)
temp$НОМЕНКЛАТУРА[100]
retail$Наименование.товара1[107]
